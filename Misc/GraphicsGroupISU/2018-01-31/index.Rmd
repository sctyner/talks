...
Instead of symbols, use the flag of each state: ~~https://github.com/baptiste/ggflags~~ https://github.com/ellisp/ggflags

```{r ggflags, eval = FALSE}
#devtools::install_github("baptiste/ggflags")
remotes::install_github("ellisp/ggflags")
library(ggflags)
```

<img src="https://raw.githubusercontent.com/ellisp/ggflags/master/README_files/figure-markdown_github/demo-1.png" style="width: 65%" />
...
ggplot() + 
  ...
  ggflags::geom_flag(data = figdat, aes(x = -Census, y = -rank, country = state), size = 6) + 
