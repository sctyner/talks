...
- Visualizing 1, 2, or 3+ variables 
--

- Introduction to the **g**rammar of **g**raphics
--

- Building a visualization with `ggplot2` 
--
...
```{r skeleton2, echo = TRUE, out.width = "70%"}
ggplot(data = mtcars, 
       aes(x = wt, y = mpg)) #<<
```
